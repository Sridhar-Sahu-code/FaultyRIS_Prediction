...
class RISFaultCNN(nn.Module):
    def __init__(self, num_classes=16):
        super().__init__()
        # Use groups=1, larger out_channels, and kernel_size=2 to better capture the spatial correlations
...
def run_pipeline():
    ...
    cnn_det_metrics = train_and_evaluate(
        ...
        epochs=epochs, lr=lr, model_name="Classical CNN", task_name="Fault Detection"
    )
    ...
    cnn_loc_metrics = train_and_evaluate(
        ...
        epochs=epochs, lr=lr, model_name="Classical CNN", task_name="Fault Localization"
    )
